...
rs.initiate(
    {
      ...
      members: [
        ...
        { _id : 2, host : "shard1_2:27018" },
        { _id : 3, host : "shard1_3:27018" }       
      ]
    }
);
EOF
...
rs.initiate(
    {
      _id : "shard2",
      members: [
        { _id : 1, host : "shard2_1:27018" },
        { _id : 2, host : "shard2_2:27018" },
        { _id : 3, host : "shard2_3:27018" }       
      ]
    }
);
EOF
...
EOF
```
6. Проверяем количество документов в базе и количество реплик (приложение доработано, чтобы дополнительно возвращать количество реплик на каждой шарде):
```shell
